...
export default function SalesPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "O aplicativo me ajudou a entender melhor as opções. Muito completo e informativo!",
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Fixed Top Banner - Link Direto SAT */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-green-600 to-emerald-600 text-white py-3 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3">
            <Zap className="w-5 h-5 animate-pulse" />
            <span className="font-bold text-sm md:text-base">
              🎯 Acesso Direto ao SAT
            </span>
            <Link href="/sales/quiz">
              <Button 
                size="sm" 
                className="bg-white text-green-600 hover:bg-gray-100 font-bold shadow-lg hover:scale-105 transition-all"
              >
                Ir para o SAT
